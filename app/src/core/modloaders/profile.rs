//! Modloader profile types and data structures.
//!
...
mod tests {
    ...
    #[test]
    fn test_maven_to_path_forge_universal() {
        // Legacy Forge universal JAR coordinate
        assert_eq!(
            maven_to_path("net.minecraftforge:forge:1.12.2-14.23.5.2860:universal"),
