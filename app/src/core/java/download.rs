//! Java download functionality
//!
//! Similar to Prism Launcher's ArchiveDownloadTask.cpp and ManifestDownloadTask.cpp
//! Downloads Java runtimes from Adoptium and Azul APIs
